...
const SideBar = ({setContextMenu, contextMenu}) => {
  ...
  <>
    <div className="context-menu-item" onClick={() => {
      addSection(contextMenu.data.id);
      setContextMenu(null);
    }}>
      Add Section
    </div>
    ...
    <div className="context-menu-item danger" onClick={() => {
      deleteNotebook(contextMenu.data.id);
      setContextMenu(null);
    }}>
      Delete Notebook
    </div>
          ...
          {contextMenu.type === 'section' && (
            <>
              <div className="context-menu-item" onClick={() => {
                addPage(contextMenu.data.notebookId, contextMenu.data.section.id);
                setContextMenu(null);
              }}>
                Add Page
              </div>
              ...
              <div className="context-menu-item danger" onClick={() => {
                deleteSection(contextMenu.data.notebookId, contextMenu.data.section.id);
                setContextMenu(null);
              }}>
                Delete Section
              </div>
