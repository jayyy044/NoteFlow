...
// #[tauri::command]
// fn rename_notebook(notes_folder: String, notebook_id: String, new_name: String) -> Result<(), String> {
//     let root = Path::new(&notes_folder);
...
//                 section["name"] = json!(new_name.clone());
//                 break;
//             }
//         }
//     }
...
//         for page in pages {
//             if page["id"] == page_id {
//                 page["title"] = json!(new_title.clone());
//                 page["lastModified"] = json!(chrono::Utc::now().to_rfc3339());
//                 break;
//             }
//         }
//     }
...
//     page_data["lastModified"] = json!(chrono::Utc::now().to_rfc3339());
...
// #[tauri::command]
// fn add_notebook(notes_folder: String) -> Result<String, String> {
//     let root = Path::new(&notes_folder);
...
//     // Return the new notebook data as JSON string
